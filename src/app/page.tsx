        ...
        <div className="mx-auto px-4 md:px-6">
          <TestimonialCardTwo
            testimonials={[{
              ...
              imageAlt: "A deliverywoman brings a birthday surprise with flowers and a balloon to a masked recipient at their apartment."
            }]}
          />
        </div>
      </div>
      ...
      <div id="contact" data-section="contact" className="scroll-mt-24">
        <div className="mx-auto px-4 md:px-6">
          <ContactSplitForm
            ...
            imageAlt="Warm and inviting bedroom with a view of lush greenery, featuring a comfortable bed and stylish decor."
          />
        </div>
      </div>
